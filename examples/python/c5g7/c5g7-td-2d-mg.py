...
entropy_bounds = [-32.13, -10.71, -1.e50, 10.71,  32.13,  1.e50]
...
mesh.lower_left  = [-32.13, -10.71, -1.e6]
...
pin_cell_mesh.lower_left  = [-32.13, -10.71, -1.e6]
...
assembly_mesh.lower_left  = [-32.13, -10.71, -1.e6]
