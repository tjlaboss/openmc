...
_dll.openmc_circumferential_fourier_filter_set_order.argtypes = [c_int32, c_int]
_dll.openmc_circumferential_fourier_filter_set_order.restype = c_int
_dll.openmc_circumferential_fourier_filter_set_order.errcheck = _error_handler
_dll.openmc_circumferential_fourier_filter_get_surface.argtypes = [c_int32, POINTER(c_int32)]
_dll.openmc_circumferential_fourier_filter_get_surface.restype = c_int
_dll.openmc_circumferential_fourier_filter_get_surface.errcheck = _error_handler
_dll.openmc_circumferential_fourier_filter_set_surface.argtypes = [c_int32, c_int32]
_dll.openmc_circumferential_fourier_filter_set_surface.restype = c_int
_dll.openmc_circumferential_fourier_filter_set_surface.errcheck = _error_handler
...
class CircumferentialFourierFilter(Filter):
    filter_type = 'circumferentialfourier'
    ...
    def order(self):
        temp_order = c_int()
        _dll.openmc_circumferential_fourier_filter_get_order(self._index, temp_order)
        return temp_order.value

    @order.setter
    def order(self, order):
        _dll.openmc_circumferential_fourier_filter_set_order(self._index, order)

    @property
    def surface(self):
        temp_surface = c_int32()
        _dll.openmc_circumferential_fourier_filter_get_surface(self._index, temp_surface)
        return temp_surface.value

    @surface.setter
    def surface(self, surface):
        surface_id = surface if isinstance(surface, int) else surface.id
        _dll.openmc_circumferential_fourier_filter_set_surface(self._index, surface_id)
