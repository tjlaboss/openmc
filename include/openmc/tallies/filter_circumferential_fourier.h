...
class CircumferentialFourierFilter : public Filter {
public:
  //----------------------------------------------------------------------------
  // Constructors, destructors

  ~CircumferentialFourierFilter() = default;

  //----------------------------------------------------------------------------
  // Methods

  std::string type_str() const override { return "circumferentialfourier"; }
  FilterType type() const override { return FilterType::CIRCUMFERENTIAL_FOURIER; }
